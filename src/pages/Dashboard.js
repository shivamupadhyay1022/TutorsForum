...
import { nitish, profile_male, logo, close, menu } from "../assets";
import { HiArrowSmRight,HiArchive, HiChartSquareBar, HiCollection, HiClipboardList, HiTable, HiUser, HiViewBoards } from 'react-icons/hi';
...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col" >
      <div className="visible md:invisible flex p-4 flex-1 ">
        <img
   ...
   <Sidebar className={` ${
            !toggle ? "hidden" : "flex  items-center"
          } border-r md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%] relative overflow-hidden md:flex i justify-around items-center`} >
      <Sidebar.Logo
        href="#"
        img={logo}
        ...
        <Sidebar.ItemGroup className="w-full">
          <Sidebar.Item>
            <div class="mt-8 text-center">
              ...
              <h5 class="hidden mt-4 text-xl font-semibold text-gray-600 lg:block">Nitish Kumar</h5>
              <span class="hidden text-gray-400 lg:block">Class 11 Student</span>
            </div>
          </Sidebar.Item>
          <Sidebar.Item className = "bg-gradient-to-r from-sky-600 to-cyan-400 text-white"
            href="#"
            icon={HiArchive}
          >
            <p>
